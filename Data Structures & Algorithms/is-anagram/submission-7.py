class Solution:
    def isAnagram(self, s: str, t: str) -> bool:
        ...
        # using regular dictionary (TWO dicts): time O(n + m), space O(n + m)
        # if len(s) != len(t):
        #     return False 
        # dictS, dictT = {}, {}
        # for char in s:
        ...
        # using defaultdict (TWO dicts): time O(n + m), space O(n + m)
        # if len(s) != len(t):
        #     return False 
        ...
        #using regular dictionary (ONE dict): time O(n + m), space O(n + m)
        if len(s) != len(t):
            return False
        dict = {}
        for char in s:
        ...
        #using defaultdict (ONE dict): time O(n + m), space O(n + m)
        # if len(s) != len(t):
        #     return False
