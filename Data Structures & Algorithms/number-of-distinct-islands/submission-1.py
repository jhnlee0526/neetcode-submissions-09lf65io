class Solution:
    def numDistinctIslands(self, grid: List[List[int]]) -> int:
        # [Distinct Island] : 
        #   Counts only unique shapes of islands
        #   Two islands are considered the same if they have the exact same shape (can be translated/moved to match)
        #   They cannot be rotated or reflected
